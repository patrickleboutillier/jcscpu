...
# Add our extra connections to the Harness
my steps = BB.GetWire("STP.bus") ;
my clke = BB.GetWire("CLK.clke") ;
new AND(clke, steps.GetWire(5), BB.GetWire("ACC.e")) ;
new AND(clke, steps.GetWire(4), BB.GetWire("R0.e")) ;
new AND(clke, steps.GetWire(3), BB.GetWire("R1.e")) ;
my clks = BB.GetWire("CLK.clks") ;
new AND(clks, steps.GetWire(3), BB.GetWire("TMP.s")) ;
new AND(clks, steps.GetWire(4), BB.GetWire("ACC.s")) ;
new AND(clks, steps.GetWire(5), BB.GetWire("R0.s")) ;
...
BB.GetWire("CLK")->tick() ;
BB.GetWire("CLK")->tick() ;
is(BB.GetWire("TMP")->power(), "00010110", "TMP contains 00010110 (22)") ;
BB.GetWire("CLK")->tick() ;
is(BB.GetWire("ACC")->power(), "00101010", "ACC contains 00101010 (42)") ;
BB.GetWire("CLK")->tick() ;
is(BB.GetWire("R0")->power(), "00101010", "R0 contains 00101010 (42)") ;
